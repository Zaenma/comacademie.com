            ...
            <div class="container mt-5">
                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                        ...
                        <!-- Title -->
                        <h1 class="mb-0 display-8 text-primary px-mt-5">Donnez des ailes à votre apprentissages
                            <span class="position-relative">avec comacademie
                                <!-- SVG START -->
                        ...
                        <!-- Content -->
                        <p class="my-4 lead">Bienvenue sur <strong class="text-primary">comacademie</strong>, votre
                            plateforme éducative tout-en-un dédiée à
                            l'excellence académique et à la réussite des étudiants des Comores. Explorez notre vaste gamme
                            de ressources pédagogiques, engagez-vous dans un apprentissage interactif et faites partie d'une
                            communauté d'apprenants passionnés.</p>
                        ...
                        <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
                            <li class="list-inline-item me-2"> <i
                                    class="bi bi-patch-check-fill text-primary h6 me-1"></i>Ressources
                                complètes et variées</li>
                            <li class="list-inline-item me-2"> <i
                                    class="bi bi-patch-check-fill text-primary h6 me-1"></i>Soutien
                                personnalisé et accompagnement</li>
                            <li class="list-inline-item"> <i
                                    class="bi bi-patch-check-fill text-primary h6 me-1"></i>Communauté
                        ...
                        <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                            <!-- Button -->
                            <a href="https://zaenma.com/" class="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">Joindre la
                                communauté</a>
                            <!-- Video button -->
