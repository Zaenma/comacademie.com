    ...
    <nav class="navbar navbar-expand-xl">
        <div class="container-fluid px-3 px-xl-5">
            ...
            <a class="navbar-brand" href="{{ route('comacademie.index') }}">
                <img class="light-mode-item navbar-brand-item" src="assets/images/comlogo.PNG" alt="logo">
                <img class="dark-mode-item navbar-brand-item" src="assets/images/comlogo.PNG" alt="logo">
            </a>
            <!-- Logo END -->
