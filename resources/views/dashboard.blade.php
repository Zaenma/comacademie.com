                                ...
                                <div class="col-auto">
                                    <div class="avatar avatar-xxl position-relative mt-n3">
                                        <img class="avatar-img rounded-circle border border-white border-3 shadow"
                                            ...
                                            alt="">
                                        <span
                                            class="badge text-bg-success rounded-pill position-absolute top-50 start-100 translate-middle mt-4 mt-md-5 ms-n3 px-md-3">Aprénant</span>
                                    </div>
                                </div>
                                <!-- Profile info -->
                                <div class="col d-sm-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <ul class="list-inline mb-0">
                                            ...
                                            <li class="list-inline-item me-3 mb-1 mb-sm-0">
                                                <span class="h6">0</span>
                                                <span class="text-body fw-light">Cours terminé</span>
                                            </li>
                                            {{-- <li class="list-inline-item me-3 mb-1 mb-sm-0">
                                                <span class="h6">0</span>
                                    ...
                                    <div class="mt-2 mt-sm-0">
                                        <a href="student-course-list.html" class="btn btn-outline-primary mb-0">Voir mes
                                            cours</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="offcanvas-xl offcanvas-end" tabindex="-1" id="offcanvasSidebar">
                            ...
                            <div class="offcanvas-header bg-light">
                                <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Mon profile</h5>
                            ...
                            <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                                <div
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <p class="mb-0 h6 fw-light">Totals des cours</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Counter item -->
                            <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                                <div
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <p class="mb-0 h6 fw-light">Leçons suivies</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Counter item -->
                            <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                                <div
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <p class="mb-0 h6 fw-light">Certificat obtenue</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <!-- Image -->
                                                        <div class="w-100px">
                                                            <img src="assets/images/courses/4by3/05.jpg" class="rounded"
                                                                alt="">
                                                        </div>
                                                        <div class="mb-0 ms-2">
                                                            <!-- Title -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <!-- Image -->
                                                        <div class="w-100px">
                                                            <img src="assets/images/courses/4by3/01.jpg" class="rounded"
                                                                alt="">
                                                        </div>
                                                        <div class="mb-0 ms-2">
                                                            <!-- Title -->
