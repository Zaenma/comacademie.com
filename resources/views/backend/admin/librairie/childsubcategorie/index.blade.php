            ...
            <div class="container position-relative"
                ...
                <div class="row g-4">
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('childsubcategories.create') }}" class="btn btn-primary"> <i class="fa fa-plus"
                                                    ...
                                                    <div class="card card-body shadow p-2">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <h5 class="ms-3 mb-0"> <a
                                                                    ...
                                                                    <i class="fa fa-angle-right mx-3"
                                                                        aria-hidden="true"></i>
                                                                    {{ $subcategorie->subcategorie_nom }}
                                                                    <i class="fa fa-angle-right mx-3"
                                                                        aria-hidden="true"></i>
                                                                    {{ $childsubcategorie->childsubcategorie_nom }}
                                                                </a>
                                                            </h5>
                                                        </div>
                                                    </div>
